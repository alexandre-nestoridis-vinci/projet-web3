...
  constructor(private newsService: NewsService, private backendService: BackendService, private articleCacheService: ArticleCacheService) {}
...
    
    this.articleCacheService.allArticlesCache = this.allFetchedNews; 
...
          this.articles = articles; // Rempli la liste d'affichage
          this.articleCacheService.allArticlesCache = articles; 
          this.suggestionResults = articles.slice(0, 10);
        },
        error: (err: any) => {
